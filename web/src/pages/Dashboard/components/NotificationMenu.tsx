...
>
        <Box sx={{ px: 3, py: 2 }}>
          ...
          >
            Alertas de stock en productos y materiales
          </Typography>
        </Box>
              ...
              >
                <Box
                  sx={{
                    ...
                    borderRadius: 3,
                    border: "1px solid #e9d5ff",
                    boxShadow: "0px 2px 8px rgba(124, 58, 237, 0.15)",
                ...
                >
                  ...
                  <Box sx={{ flexGrow: 1 }}>
                    ...
                    <Typography
                      fontWeight={700}
                      fontSize={15}
                      sx={{ mt: 0.5, color: "#4c1d95" }}
                    >
                      {n.nombre}
                    </Typography>

                    <Typography fontSize={13} sx={{ mt: 0.5, color: "#b91c1c" }}>
                      {n.mensaje}
                    </Typography>
                  </Box>
                </Box>
